...
impl Plugin for MainMenuPlugin {
    fn build(&self, app: &mut AppBuilder) {
        app.init_resource::<MenuMaterials>()
            .add_system(button_style_system.system())
            .add_system(button_press_system.system())
            .add_system_set(SystemSet::on_enter(AppState::MainMenu).with_system(setup_system.system()))
            .add_system_set(SystemSet::on_exit(AppState::MainMenu).with_system(cleanup_system.system()));
    }
}
...
fn button_text(asset_server: &Res<AssetServer>, materials: &Res<MenuMaterials>, label: &str) -> TextBundle {
    return TextBundle {
        ...
        text: Text::with_section(
            label,
            TextStyle {
                font: asset_server.load("fonts/FallingSky-JKwK.otf"),
                font_size: 30.0,
                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            ...
                            // TODO essayer de simplifier ça
                            // par exemple une fonction 
                            // createButton(label).insert(MenuButton::Play)
...
fn cleanup_system(mut commands: Commands, menu_data: Res<MainMenuData>) {
